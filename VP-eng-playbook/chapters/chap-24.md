...
```mermaid
%% Figure 24.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 24.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-24-crisis-response-at-scale.md`.

**Deliverable:** `portfolio/chapter-24-crisis-response-at-scale.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-24-crisis-response-at-scale.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
