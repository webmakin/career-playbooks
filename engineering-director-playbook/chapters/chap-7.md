...
This chapter will tell you what the engineering career ladders discipline is, the 3-5 mental models that compress it, the 3 reusable frameworks, and the 5-criterion quality bar that separates a portfolio ED from a non-portfolio ED.
...
_Four mental models that compress the engineering career ladders discipline. Each will be a numbered Mermaid figure in v1.0.0._
...
_Three reusable frameworks for engineering career ladders. Each will have a 1-page template in v1.0.0._
