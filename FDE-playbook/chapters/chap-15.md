...
```mermaid
%% Figure 15.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-15-the-fde-feedback-loop.md`.

**Deliverable:** `portfolio/chapter-15-the-fde-feedback-loop.md` — _one sentence description._
...
Save your filled-in drill as `portfolio/chapter-15-the-fde-feedback-loop.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
