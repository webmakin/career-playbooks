...
This chapter will tell you what the engineering auditability discipline is, the 3-5 mental models that compress it, the 3 reusable frameworks, and the 5-criterion quality bar that separates a portfolio ED from a non-portfolio ED.
...
_Four mental models that compress the engineering auditability discipline. Each will be a numbered Mermaid figure in v1.0.0._
...
_Three reusable frameworks for engineering auditability. Each will have a 1-page template in v1.0.0._
...
You have **90 minutes**. Produce the **Engineering Auditability artifact** (`portfolio/chapter-25-engineering-auditability.md`) using the 3 frameworks above. Specify: TBD.
...
Save your filled-in drill as `portfolio/chapter-25-engineering-auditability.md` — interview evidence for engineering auditability (see Portfolio Map in Chapter 27).
