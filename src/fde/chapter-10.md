...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-10-the-deployment-methodology.md`.

**Deliverable:** `portfolio/chapter-10-the-deployment-methodology.md` — _one sentence description._
...
Save your filled-in drill as `portfolio/chapter-10-the-deployment-methodology.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
