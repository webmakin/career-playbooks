...
# Security and Compliance at the Customer
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-23-security-and-compliance-at-the.md`.

**Deliverable:** `portfolio/chapter-23-security-and-compliance-at-the.md` — _one sentence description._
...
Save your filled-in drill as `portfolio/chapter-23-security-and-compliance-at-the.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
