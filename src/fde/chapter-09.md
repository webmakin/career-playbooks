...
# Performance, Cost, and Scale at the Customer
...
```mermaid
%% Figure 09.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-09-performance-cost-and-scale-at.md`.

**Deliverable:** `portfolio/chapter-09-performance-cost-and-scale-at.md` — _one sentence description._
...
Save your filled-in drill as `portfolio/chapter-09-performance-cost-and-scale-at.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
