...
```mermaid
%% Figure 09.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-09-engineering-quality-at-scale.md`.

**Deliverable:** `portfolio/chapter-09-engineering-quality-at-scale.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-09-engineering-quality-at-scale.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
