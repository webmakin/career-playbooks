...
```mermaid
%% Figure 18.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 18.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-18-engineering-org-design-at-scal.md`.

**Deliverable:** `portfolio/chapter-18-engineering-org-design-at-scal.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-18-engineering-org-design-at-scal.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
