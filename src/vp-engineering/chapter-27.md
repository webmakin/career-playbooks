...
```mermaid
%% Figure 27.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 27.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-27-the-vpe-portfolio-map.md`.

**Deliverable:** `portfolio/chapter-27-the-vpe-portfolio-map.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-27-the-vpe-portfolio-map.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
