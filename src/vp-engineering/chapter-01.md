...
- **The Director-With-More-Reports Trap.** VPE acts like a Director managing more engineers, missing the portfolio-and-strategy cognitive shift.

- **The Lone-Wolf Architect.** VPE spends most of their time on technical decisions, deprioritizing people and organizational work.

- **The Ivory-Tower Strategist.** VPE produces beautiful strategy memos that don't connect to what the org can actually execute.
...
```mermaid
%% Figure 01.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-01-what-a-vp-of-engineering-actua.md`.

**Deliverable:** `portfolio/chapter-01-what-a-vp-of-engineering-actua.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-01-what-a-vp-of-engineering-actua.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
