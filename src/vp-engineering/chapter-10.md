...
# Engineering Lifecycle (Discovery to Decommission)
...
```mermaid
%% Figure 10.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 10.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-10-engineering-lifecycle-discover.md`.

**Deliverable:** `portfolio/chapter-10-engineering-lifecycle-discover.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-10-engineering-lifecycle-discover.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
