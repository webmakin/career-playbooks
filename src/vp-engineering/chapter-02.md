...
- **The 10x IC Mentality.** VPE evaluates their own impact by their personal technical output, not by the org's output.

- **The Consensus-Seeker.** VPE makes no decision that isn't unanimous, treating leadership as consensus-building.

- **The All-Things-To-All-People Director.** VPE continues to do the things that worked as a Director (1:1s, deep code review, mentoring) at the VPE level.
...
```mermaid
%% Figure 02.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 02.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-02-the-director-to-vp-category-ch.md`.

**Deliverable:** `portfolio/chapter-02-the-director-to-vp-category-ch.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-02-the-director-to-vp-category-ch.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
