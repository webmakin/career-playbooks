...
```mermaid
%% Figure 05.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 05.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-05-engineering-strategy-at-compan.md`.

**Deliverable:** `portfolio/chapter-05-engineering-strategy-at-compan.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-05-engineering-strategy-at-compan.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
