...
```mermaid
%% Figure 12.1 — diagram title placeholder
flowchart LR
    A[Concept] --> B[Concept]
    B --> C[Concept]
```
...
```mermaid
%% Figure 12.2 — diagram title placeholder
flowchart TB
    A[Concept] --> B[Concept]
```
...
You have **90 minutes**. Deliver _single artifact_ as `portfolio/chapter-12-reliability-slos-and-incident.md`.

**Deliverable:** `portfolio/chapter-12-reliability-slos-and-incident.md` — _one sentence description of what the reader produces._
...
Save your filled-in drill as `portfolio/chapter-12-reliability-slos-and-incident.md` — this is interview evidence for _[specific question type]_ (see Portfolio Map in Chapter 27).
