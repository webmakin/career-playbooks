...
You are a Principal AI Scientist at acme-corp. Regulatory Landscape for AI is one of the Principal AI Scientist-only disciplines.

This chapter will tell you what the regulatory landscape for ai discipline is, the 4 mental models that compress it, the 3 reusable frameworks, and the 5-criterion quality bar that separates a portfolio Principal AI Scientist from a non-portfolio Principal AI Scientist.
...
Five named failure modes of Principal AI Scientists whose regulatory landscape for ai produced zero results.
