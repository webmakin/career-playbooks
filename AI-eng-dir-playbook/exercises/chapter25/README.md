# Chapter 25 — Exercise Bundle: Auditability and the Audit Trail
...
| # | Dimension | Score (1-5) |
|---|-----------|------------|
| 7-element coverage | ___ |
| Retention per element | ___ |
| Reproducibility test | ___ |
| Query latency tier | ___ |
| Backup + DR | ___ |
...
Save your filled-in drill as `portfolio/chapter-25-audit-trail-response.md` — interview evidence (see Portfolio Map in Chapter 27).
