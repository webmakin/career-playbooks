# Chapter 12 — Exercise Bundle: Reliability, Observability, and Incident Response
...
| # | Dimension | Score (1-5) |
|---|-----------|------------|
| Reliability Checklist score per feature | ___ |
| Dashboard + alerting design | ___ |
| On-call rotation clarity | ___ |
| Quarterly drill schedule | ___ |
| Process change identification | ___ |
...
Save your filled-in drill as `portfolio/chapter-12-reliability-upgrade-plan.md` — interview evidence (see Portfolio Map in Chapter 27).
