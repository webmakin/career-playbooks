# Chapter 16 — Exercise Bundle: Build a Compelling AI Business Case
...
| # | Dimension | Score (1-5) |
|---|-----------|------------|
| 3-year TCO per project (5 layers) | ___ |
| Benefit confidence scoring | ___ |
| Payback period per project | ___ |
| Fund/defer/decline decision | ___ |
| Kill criteria for funded project | ___ |
...
Save your filled-in drill as `portfolio/chapter-16-business-case-comparison.md` — interview evidence (see Portfolio Map in Chapter 27).
