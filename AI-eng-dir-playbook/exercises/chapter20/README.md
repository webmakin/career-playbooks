# Chapter 20 — Exercise Bundle: Performance Management and Career Frames
...
| # | Dimension | Score (1-5) |
|---|-----------|------------|
| AI-specific career ladder | ___ |
| Evidence-based promotion | ___ |
| Quarterly review cadence | ___ |
| Comp curve discipline | ___ |
| Promotion signal value | ___ |
...
After completing the drill, fill in your scores per dimension in the worked-example.md template.

## Portfolio

Save your filled-in drill as `portfolio/chapter-20-perf-promo-memo.md` — interview evidence (see Portfolio Map in Chapter 27).
